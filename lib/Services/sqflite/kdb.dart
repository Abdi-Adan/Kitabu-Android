// import 'package:kitabu_android/Models/CreditItem.dart';
...
//   //New Customer
//   Future<int> insertCreditor(Debtor creditor) async {
//     Database db = await this.database;
...
//   Future<int> updateCreditor(Debtor debtor) async {
//     Database db = await this.database;
//     var result = await db.update(creditorTable, debtor.toMap(),
